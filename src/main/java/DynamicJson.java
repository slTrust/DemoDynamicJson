...
public class DynamicJson {
    public static void main(Object[] args) throws MalformedURLException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        // 通过命令行输入 动态加载 fastjson版本
        System.out.println("请输入你想使用的 fastjson版本");
        Scanner scanner = new Scanner(System.in);
        Object version = scanner.next();
